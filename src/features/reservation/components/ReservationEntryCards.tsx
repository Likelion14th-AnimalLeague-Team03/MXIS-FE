...
export function ConciergePromoCard({ onPress }: { onPress: () => void }) {
  return (
    <Card className="mt-4 border-0 bg-white px-3 py-5">
      <View className="flex-row items-center gap-4">
        ...
        <View className="flex-1">
          <Text className="text-[15px] font-semibold text-[#221F1D]">
            케어 컨시어지 예약
          </Text>
          <Text className="mt-1 text-[10px] text-[#4E4945]">
...
export function FreeCareCard({ onPress }: { onPress: () => void }) {
  return (
    <Card className="mt-4 rounded-[20px] border-0 bg-concierge-surfaceMuted px-3 py-5">
      <View className="flex-row items-center gap-4">
        ...
        <View className="flex-1">
          <Text className="text-[15px] font-semibold text-[#1E1A17]">
            무상 케어를 제안드려요.
          </Text>
          <Text className="mt-1 text-[10px] leading-[14px] text-[#4A423C]">
            가까운 매장에서 케어 서비스를{"\n"}예약해보세요.
          </Text>
        </View>
      </View>
